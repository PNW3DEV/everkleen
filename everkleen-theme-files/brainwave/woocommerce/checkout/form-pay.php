	...
	<div id="payment">
				...
				if ( $available_gateways = WC()->payment_gateways->get_available_payment_gateways() ) {
					...
					foreach ( $available_gateways as $gateway ) {
						...
						<li class="radio payment_method_<?php echo $gateway->id; ?>">
							...
							<label class="check_label_radio" for="payment_method_<?php echo $gateway->id; ?>"><?php echo $gateway->get_title(); ?> <?php echo $gateway->get_icon(); ?></label>
							<?php
		...
		<div class="form-row">
			...
			<?php
				...
				echo apply_filters( 'woocommerce_pay_order_button_html', '<input type="submit" class="button btn btn-primary alt" id="place_order" value="' . esc_attr( $pay_order_button_text ) . '" data-value="' . esc_attr( $pay_order_button_text ) . '" />' );
			?>
