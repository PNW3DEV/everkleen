...
<h2 class="text-uppercase"><?php echo esc_html( $page_title ); ?></h2>
...
<?php foreach ( $get_addresses as $name => $title ) : ?>
	...
	<div class="col-<?php echo ( ( $col = $col * -1 ) < 0 ) ? 1 : 2; ?> address col-sm-6 col-xs-12">
		<header class="title">
			<h3 class="text-uppercase"><?php echo esc_html( $title ); ?></h3>
